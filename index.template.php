...
/*	This template is, perhaps, the most important template in the theme. It
	...
	2.1 Fusion theme by idesignSMF.com
*/
...
function template_body_above()
{
	...
	if ($context['user']['is_logged'])
	{
		...
		if ($context['allow_pm'])
			echo '
				<li>
					<a href="', $scripturl, '?action=pm"', !empty($context['self_pm']) ? ' class="active"' : '', ' id="pm_menu_top"><i class="fas fa-envelope-open"></i>', !empty($context['user']['unread_messages']) ? ' <span class="amt">' . $context['user']['unread_messages'] . '</span>' : '', '</a>
		...
		echo '
				<li>
					<a href="', $scripturl, '?action=unread" title="', $txt['unread_since_visit'], '"> <i class="fas fa-star"></i></a>
				</li>';
		echo '
				<li>
				    <a href="', $scripturl, '?action=unreadreplies" title="', $txt['show_unread_replies'], '"><i class="fas fa-bullhorn"></i></a>
				</li>';
...
function template_body_below()
{
	...
	echo '
		<ul>
			...
			<li class="copyright">', theme_copyright(), ' | ', idesign_copyright(), '</li>
		</ul>';
...
// idesignSMF.com theme copyright
function idesign_copyright() {
	$idesign = '<a href="https://www.idesignsmf.com" target="_blank" rel="noopener" title="Free Responsive SMF Themes">idesignSMF</a>';
